...
export default function ReviewSheet({
  ...
  return (
    <div className="fixed inset-0 z-[100]">
      ...
      {/* Sheet */}
      <div
        className={`absolute inset-x-0 bottom-0 max-h-[92%] overflow-y-auto overflow-x-hidden rounded-t-[26px] bg-bg transition-transform duration-300 ${shown ? "translate-y-0" : "translate-y-full"}`}
      >
